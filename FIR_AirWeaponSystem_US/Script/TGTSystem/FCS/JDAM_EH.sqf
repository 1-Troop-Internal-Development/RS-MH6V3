...
if (_AB == 1) then
{
		_airburst = [_projectile,_ammoname] execVM "\FIR_AirWeaponSystem_US\script\WEP\bomb_airburst.sqf";
};

if (_BS == 1) then
{
		_bunkerbuster = [_projectile] execVM "\FIR_AirWeaponSystem_US\script\WEP\BLU109.sqf";
};
