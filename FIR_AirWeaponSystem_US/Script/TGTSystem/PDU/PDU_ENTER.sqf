...
private ["_user","_tgtpos","_targetset","_select_mem","_tgt_grid","_grid1","_grid2","_grid_1_last","_grid_2_last","_gridarray","_grid_1_last_10d","_grid_2_last_10d","_check"];

_lb = (findDisplay 5589) displayCtrl 2100;
_edit = (findDisplay 5589) displayCtrl 1400; 
_select_mem = lbCurSel _lb;

_user = player;
_grid = ctrlText _edit;

_type = _user getvariable ["ITGT_GRIDTYPE","8D"];
...
systemChat "SYSTEM : Record Target Coordinates to Memory.";
...
_nan = round(random 10000);
	...
	Switch (_select_mem) do
	{
		case -1:
		{
			...
			_user setvariable ["ITGT_DATA_1",_tgt_grid,true];
		...
		case 1:
		{
			...
			_user setvariable ["ITGT_DATA_2",_tgt_grid,true];
		...
		case 2:
		{
			...
			_user setvariable ["ITGT_DATA_3",_tgt_grid,true];
		...
		case 3:
		{
			...
			_user setvariable ["ITGT_DATA_4",_tgt_grid,true];
		...
		case 4:
		{
			...
			_user setvariable ["ITGT_DATA_5",_tgt_grid,true];
